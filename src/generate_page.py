...
def generate_dir(from_dir, template_path, dest_dir):
    ...
    for file in files:
        ...
        if os.path.isfile(new_filepath):
            ...
            generate_page(new_filepath, abs_template_path, dest_path)
        else:
            os.mkdir(os.path.join(dest_dir, file))
            generate_dir(new_filepath, abs_template_path, os.path.join(dest_dir, file))